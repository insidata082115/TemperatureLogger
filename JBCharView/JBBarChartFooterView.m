...
// Colors
static UIColor *BarChartFooterViewDefaultBackgroundColor = nil;
...
+ (void)initialize
{
	...
	{
		BarChartFooterViewDefaultBackgroundColor = ColorBarChartControllerBackground;
	}
}
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        self.backgroundColor = BarChartFooterViewDefaultBackgroundColor;
        
        _padding = BarChartFooterPolygonViewDefaultPadding;
        
        _leftLabel = [[UILabel alloc] init];
        _leftLabel.adjustsFontSizeToFitWidth = YES;
        _leftLabel.font = FontFooterLabel;
        ...
        _rightLabel.font = FontFooterLabel;
